...
**AOS context** (`apps/desktop/`): DESIGN.md is law for tokens (colors, fonts, spacing). This skill governs *composition* — how those tokens are arranged into something with personality.
