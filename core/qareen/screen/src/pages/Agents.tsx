...
const DEPT_META: Record<Department, { label: string; color: string; icon: ReactNode }> = {
  ...
  engineering: { label: 'Engineering', color: '#D6CCB4', icon: <Code className="w-3.5 h-3.5" /> },
...
const COMMUNITY_AGENTS: CommunityAgent[] = [
  ...
  },
  {
    ...
    model: 'sonnet', color: '#D6CCB4', emoji: '🗄️',
  ...
  },
  {
    ...
    model: 'sonnet', color: '#C9BEA0', emoji: '🔧',
    tools: ['Read', 'Write', 'Edit', 'Bash'],
