    ...
    def handler(request: httpx.Request) -> httpx.Response:
        ...
        if request.method == "GET" and path.endswith("/cfd_tunnel"):
            ...
            return httpx.Response(
                200,
                json=_envelope(
                    [{"id": "tun-1", "name": "qareen-mac", "deleted_at": None}]
                ),
            )
